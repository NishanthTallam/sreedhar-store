...
export function Footer() {
  return (
    <footer className="w-full border-t border-neutral-200 bg-neutral-50 pb-20 md:pb-0">
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="flex flex-col gap-4">
            <h3 className="text-lg font-bold text-brand-700">Sreedhar Store</h3>
            <p className="text-sm text-neutral-600">
              Your neighborhood hypermarket, bringing fresh produce and household essentials right to your door.
            </p>
            <p className="text-sm font-semibold text-brand-600">Everything Below MRP</p>
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm text-neutral-600"><strong>Store Name:</strong> Sreedhar Store</p>
            <p className="text-sm text-neutral-600"><strong>Location:</strong> Bukkapatnam, Puttaparthi, Andhra Pradesh</p>
            <p className="text-sm text-neutral-600"><strong>Email:</strong> tallamnishanth@gmail.com</p>
            <p className="text-sm text-neutral-600"><strong>Phone:</strong> +91 7989102722</p>
            <p className="text-sm text-neutral-600"><strong>WhatsApp:</strong> +91 7989102722</p>
            
            <div className="flex items-center gap-4 mt-2">
              <a href="#" className="text-neutral-500 hover:text-brand-600" aria-label="Facebook">
                <Facebook className="h-5 w-5" />
              </a>
              <a href="#" className="text-neutral-500 hover:text-brand-600" aria-label="Instagram">
                <Instagram className="h-5 w-5" />
              </a>
              <a href="https://wa.me/917989102722" className="text-neutral-500 hover:text-brand-600" aria-label="WhatsApp">
              ...
              <a href="mailto:tallamnishanth@gmail.com" className="text-neutral-500 hover:text-brand-600" aria-label="Gmail">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 12.713l11.985-8.71C23.518 2.457 21.905 1.5 20 1.5H4C2.095 1.5.482 2.457 0.015 4.003L12 12.713zm0 2.474L0 6.477V20.5c0 1.105.895 2 2 2h20c1.105 0 2-.895 2-2V6.477l-12 8.71z" />
                </svg>
              </a>
            </div>
          </div>
        </div>
        <div className="mt-8 border-t border-neutral-200 pt-8 text-center md:flex md:items-center md:justify-between md:text-left">
          <p className="text-sm text-neutral-500">
            &copy; 2026 Sreedhar Store. All Rights Reserved.
          </p>
        </div>
      </div>
    </footer>
