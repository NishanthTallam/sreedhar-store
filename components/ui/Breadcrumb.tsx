...
>(({ asChild, className, ...props }, ref) => {
  ...
  // For asChild, you normally use Slot, but keeping it simple here without @radix-ui/react-slot dependency if not needed.
  // Actually, we do have it. So let's use it or just stick to simple a tag for now.
  return (
    <Comp
      ref={ref as any}
